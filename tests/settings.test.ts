...
describe('Settings', () => {
  ...
  describe('API Keys', () => {
    ...
    it('should set API keys for different providers', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('openaiKey', 'new-openai-key');
      expect(mockStoreInstance.set).toHaveBeenCalledWith('anthropicKey', 'new-anthropic-key');
      expect(mockStoreInstance.set).toHaveBeenCalledWith('grokKey', 'new-grok-key');
      expect(mockStoreInstance.set).toHaveBeenCalledWith('geminiKey', 'new-gemini-key');
    });
  ...
  describe('Max Output Tokens', () => {
    it('should set and get max output tokens', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('maxOutputTokens', 4096);

      mockStoreInstance.get.mockReturnValue(4096);
  ...
  describe('Web Search Settings', () => {
    it('should set and get web search enabled', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('enableWebSearch', true);
    ...
    it('should set and get max web search uses', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('maxWebSearchUses', 10);

      mockStoreInstance.get.mockReturnValue(10);
  ...
  describe('Extended Thinking Settings', () => {
    it('should set and get extended thinking enabled', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('enableExtendedThinking', true);
  ...
  describe('Prompt Caching Settings', () => {
    it('should set and get prompt caching enabled', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('enablePromptCaching', true);
    ...
    it('should set and get prompt cache TTL', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('promptCacheTTL', '1h');

      mockStoreInstance.get.mockReturnValue('1h');
  ...
  describe('Streaming Settings', () => {
    it('should set and get streaming enabled', () => {
      ...
      expect(mockStoreInstance.set).toHaveBeenCalledWith('enableStreaming', true);
  ...
  describe('Key Validation', () => {
    ...
    it('should return false if provider is not found', async () => {
      mockStoreInstance.get.mockReturnValue('test-key');
    ...
    it('should return false for authentication errors', async () => {
      mockStoreInstance.get.mockReturnValue('invalid-key');
    ...
    it('should return true for non-auth errors (network issues)', async () => {
      mockStoreInstance.get.mockReturnValue('valid-key');
